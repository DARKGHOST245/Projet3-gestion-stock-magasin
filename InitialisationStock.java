...
public class InitialisationStock {
    ...
    static {
        Produit.add(new Electromenager("EL001 ", " Réfrigérateur LG " , "LG ",450.5,10, " Frigo basse " ,150,120, "Cuisine "));
        Produit.add(new Electromenager(" EL002 ", "Micro-onde Samsung ", "Samsung ",120.0,7, " Micro-onde 800W ",800,50, " Cuisine " ));
        Produit.add(new Electromenager("EL003 " , " Lave-linge Bosch " , " Bosch " ,600.0,5, " Lave-linge 7kg ",1000,200, " Buanderie "));
        Produit.add(new Electromenager( "EL004 ", "Climatiseur LG", "LG ",750.0,3, "Climatisation 12000 BTU ",1500,400, " Chambre ")) ;
        Produit.add(new Electromenager(" EL005 ", "Four Electrolux ", "Electrolux ",500.0,6, "Four électrique ",2000,300, "Cuisine ")) ;
